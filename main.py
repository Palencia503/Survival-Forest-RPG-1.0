...
def obtener_monstruos_base():
    return {
        ...
        2:  ("Lobo", 70, 0, 6, 14, 2, {"tipo": "otros", "nombre": "Colmillo afilado"}),
        3:  ("Esqueleto", 80, 0, 8, 12, 3, {"tipo": "armas", "nombre": "Hueso afilado", "dano": 3}),
        4:  ("Bandido", 90, 0, 10, 15, 4, {"oro": 20}),
        5:  ("Orco", 110, 5, 12, 18, 5, {"tipo": "armas", "nombre": "Espada oxidada", "dano": 5}),

        6:  ("Trol pequeno", 130, 5, 14, 20, 6, {"oro": 25}),
        7:  ("Murcielago gigante", 120, 0, 10, 22, 7, {"tipo": "otros", "nombre": "Ala oscura"}),
        8:  ("Zombi", 140, 0, 12, 20, 8, {"tipo": "pociones", "nombre": "Pocion debil", "curacion": 20}),
        9:  ("Guerrero esqueleto", 150, 0, 15, 25, 9, {"tipo": "armas", "nombre": "Espada rota", "dano": 4}),
        10: ("Ogro", 180, 5, 18, 28, 10, {"oro": 40}),

        11: ("Lobo alfa", 200, 0, 20, 30, 11, {"tipo": "otros", "nombre": "Garra afilada"}),
        12: ("Chaman orco", 180, 20, 15, 32, 12, {"tipo": "pociones", "nombre": "Pocion magica", "curacion": 40}),
        13: ("Golem de piedra", 250, 0, 25, 35, 13, {"oro": 50}),
        14: ("Arana gigante", 220, 0, 18, 33, 14, {"tipo": "otros", "nombre": "Veneno viscoso"}),
        15: ("Caballero oscuro", 260, 10, 30, 40, 15, {"tipo": "armas", "nombre": "Espada negra", "dano": 10}),

        16: ("Trol de guerra", 300, 10, 28, 42, 16, {"oro": 60}),
        17: ("Espectro", 240, 30, 10, 38, 17, {"tipo": "otros", "nombre": "Esencia oscura"}),
        18: ("Minotauro", 320, 0, 22, 45, 18, {"tipo": "armas", "nombre": "Hacha rota", "dano": 8}),
        19: ("Harpia", 260, 0, 15, 40, 19, {"tipo": "otros", "nombre": "Pluma afilada"}),
        20: ("Golem de hierro", 350, 0, 35, 50, 20, {"oro": 80}),

        21: ("Demonio menor", 300, 20, 25, 48, 21, {"tipo": "pociones", "nombre": "Pocion infernal", "curacion": 60}),
        22: ("Serpiente colosal", 330, 0, 18, 52, 22, {"tipo": "otros", "nombre": "Escama venenosa"}),
        23: ("Nigromante", 280, 40, 12, 45, 23, {"oro": 100}),
        24: ("Caballero maldito", 360, 10, 30, 55, 24, {"tipo": "armas", "nombre": "Espada maldita", "dano": 15}),
        25: ("Trol anciano", 400, 15, 32, 60, 25, {"oro": 120}),

        26: ("Dragon joven", 450, 20, 40, 65, 26, {"tipo": "otros", "nombre": "Escama roja"}),
        27: ("Demonio mayor", 420, 30, 35, 70, 27, {"oro": 150}),
        28: ("Titan de roca", 500, 0, 45, 75, 28, {"tipo": "otros", "nombre": "Nucleo de piedra"}),
        29: ("Dragon adulto", 600, 40, 50, 80, 29, {"tipo": "armas", "nombre": "Colmillo de dragon", "dano": 20}),
        30: ("Senor demonio", 700, 50, 60, 90, 30, {"oro": 200})
    }

#armas por defecto de los personajes
def armas():
    return {
        "Tanque": {
            "nom": "Escudo Simple",
        ...
        try:
            ...
            if opcion in personajes_base:
                ...
                if clase in armas_base:
                    jugador.equipar_arma(armas_base[clase]["nom"], armas_base[clase]["dano"])
...
def menu_equipar_arma(jugador):
    ...
    arma = armas[idx]
    jugador.equipar_arma(arma.nombre, arma.dano)
    input("ENTER...")
